...
const Footer = () => {
  return (
    <div className="Footer">
      <footer>
        <div class="containers footerContainer">
          <div class="footer-nav flex flex-around flex-start flex-g-1">
            <div class="col flex flex-column flex-start flex-g-1">
              ...
              <p class="site-decription">
                This is the E-Commerce website made by 7th Semester Student of
            ...
            <div class="col flex flex-column flex-g-1 flex-start">
              <h3 class="col-title">Developer</h3>
              <nav class="col-list">
                <ul>
                  <li>
                    <a href="#">Suman Shah</a>
            ...
            <div class="col flex flex-column flex-g-1 flex-start">
              <h3 class="col-title">Technology</h3>
              <nav class="col-list">
                <ul>
                  <li>
                    <a href="#">React Js</a>
